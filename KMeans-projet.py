...
def main( param, param_k ):
    ...
    while( there_are_no_modification == 0 ):
        ...
        for f in xrange(0, nb_pixels):
            ...
            distance_cluster2 = ((bleu[f,0] - cluster_bleu)) ** 2 + abs(
                    (vert[f,0] - cluster_vert)) ** 2 + abs((rouge[f,0] - cluster_rouge)) ** 2
